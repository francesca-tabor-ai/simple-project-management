...
INSERT INTO labels (id, name, color, user_id, created_at, updated_at) VALUES
  ('a0000001-1111-1111-1111-111111111111', 'urgent', '#EF4444', 'dd6fbf1c-94a9-468b-8ea3-a433b811e450', NOW(), NOW()),
  ('a0000002-2222-2222-2222-222222222222', 'feature', '#3B82F6', 'dd6fbf1c-94a9-468b-8ea3-a433b811e450', NOW(), NOW()),
  ('a0000003-3333-3333-3333-333333333333', 'bug', '#F59E0B', 'dd6fbf1c-94a9-468b-8ea3-a433b811e450', NOW(), NOW()),
  ('a0000004-4444-4444-4444-444444444444', 'documentation', '#8B5CF6', 'dd6fbf1c-94a9-468b-8ea3-a433b811e450', NOW(), NOW()),
  ('a0000005-5555-5555-5555-555555555555', 'backend', '#10B981', 'dd6fbf1c-94a9-468b-8ea3-a433b811e450', NOW(), NOW()),
  ('a0000006-6666-6666-6666-666666666666', 'frontend', '#F472B6', 'dd6fbf1c-94a9-468b-8ea3-a433b811e450', NOW(), NOW()),
  ('a0000007-7777-7777-7777-777777777777', 'testing', '#6366F1', 'dd6fbf1c-94a9-468b-8ea3-a433b811e450', NOW(), NOW())
...
INSERT INTO task_labels (task_id, label_id, created_at) VALUES
  ('11111111-1111-1111-1111-111111111111', 'a0000001-1111-1111-1111-111111111111', NOW()), -- urgent
  ('11111111-1111-1111-1111-111111111111', 'a0000002-2222-2222-2222-222222222222', NOW()), -- feature
  ('11111111-1111-1111-1111-111111111111', 'a0000005-5555-5555-5555-555555555555', NOW()), -- backend
  ('11111111-1111-1111-1111-111111111111', 'a0000006-6666-6666-6666-666666666666', NOW()), -- frontend
  ('11111111-1111-1111-1111-111111111111', 'a0000007-7777-7777-7777-777777777777', NOW())  -- testing
ON CONFLICT (task_id, label_id) DO NOTHING;

-- Task 2: Write Documentation → documentation, backend
INSERT INTO task_labels (task_id, label_id, created_at) VALUES
  ('22222222-2222-2222-2222-222222222222', 'a0000004-4444-4444-4444-444444444444', NOW()), -- documentation
  ('22222222-2222-2222-2222-222222222222', 'a0000005-5555-5555-5555-555555555555', NOW())  -- backend
ON CONFLICT (task_id, label_id) DO NOTHING;

-- Task 3: Fix Critical Bug → urgent, bug, backend, testing
INSERT INTO task_labels (task_id, label_id, created_at) VALUES
  ('33333333-3333-3333-3333-333333333333', 'a0000001-1111-1111-1111-111111111111', NOW()), -- urgent
  ('33333333-3333-3333-3333-333333333333', 'a0000003-3333-3333-3333-333333333333', NOW()), -- bug
  ('33333333-3333-3333-3333-333333333333', 'a0000005-5555-5555-5555-555555555555', NOW()), -- backend
  ('33333333-3333-3333-3333-333333333333', 'a0000007-7777-7777-7777-777777777777', NOW())  -- testing
ON CONFLICT (task_id, label_id) DO NOTHING;
